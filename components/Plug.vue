...
const afterClass = computed(() => `after:absolute after:top-0 after:left-0 after:w-full after:h-full ${props.isSquared ? '' : 'after:rounded-full '}after:transform after:transform-gpu after:scale-110 after:transition-shadow after:duration-400 hover:after:shadow-[0_0_0_1px]`)
